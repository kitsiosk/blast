...
def make_eval_script_list(instance, specs, env_name, repo_directory, base_commit, test_patch):
    ...
    if instance["repo"].strip()=="sphinx-doc/sphinx":
        special_tox='pip install pytest-cov'
        special_tox1='export PYTEST_ADDOPTS="--cov=sphinx --cov-report=term-missing"'

        coverage_install="python3 -m pip install coverage"
